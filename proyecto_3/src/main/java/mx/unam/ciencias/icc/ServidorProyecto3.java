...
import mx.unam.ciencias.icc.red.ServidorBaseDeDatosMuseos;

/**
 * ServidorProyecto3: Parte del servidor para proyecto 3: Base de datos en red e
 * interfaz gráfica.
 */
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosMuseos servidor;
            servidor = new ServidorBaseDeDatosMuseos(puerto, archivo);
