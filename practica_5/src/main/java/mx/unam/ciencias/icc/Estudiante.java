 ...
 * y actualizarse con los valores de otro estudiante.
 */
public class Estudiante implements Registro {
     ...
     * líneas producidas por el método {@link Estudiante#escribeLinea} deben ser
     ...
     */
    @Override public void leeLinea(String linea) throws ExcepcionLineaInvalida {
     ...
     *         Estudiante}.
     */
    public void actualiza(Registro registro) throws IllegalArgumentException {
     ...
     *         CampoEstudiante}.
     */
    public boolean caza(Enum campo, Object valor) throws IllegalArgumentException {
        if (!(campo instanceof CampoEstudiante))
            throw new IllegalArgumentException();

        CampoEstudiante enum_campo = (CampoEstudiante)campo;
