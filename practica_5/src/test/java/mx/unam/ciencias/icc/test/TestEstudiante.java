...
public class TestEstudiante {
    ...
    /**
     * Prueba unitaria para {@link Estudiante#escribeLinea}.
     */
    @Test public void testEscribeLinea() {
        ...
        String linea = String.format("%s\t%d\t%2.2f\t%d\n",
                                 nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.escribeLinea().equals(linea));
    }

    /**
     * Prueba unitaria para {@link Estudiante#leeLinea}.
     */
