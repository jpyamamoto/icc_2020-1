...
public class TestEstudiante {
    ...
    /**
     * Prueba unitaria para {@link Estudiante#aLinea}.
     */
    @Test public void testALinea() {
        String nombre = nombreAleatorio();
        int cuenta = cuentaAleatoria();
        double promedio = promedioAleatorio();
        int edad = edadAleatoria();
        ...
        String linea = String.format("%s\t%d\t%2.2f\t%d\n",
                                     nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.aLinea().equals(linea));
    }

    /**
     * Prueba unitaria para {@link Estudiante#deLinea}.
     */
    @Test public void testDeLinea() {
