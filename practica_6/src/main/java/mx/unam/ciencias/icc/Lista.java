...
public class Lista<T> {
    ...
    private Lista<T> reversa(Nodo nodo, Lista<T> lista) {
        if (nodo == null)
            return lista;
    ...
    private Lista<T> copia(Nodo nodo, Lista<T> lista) {
        if (nodo == null)
            return lista;
    ...
    private int indiceDe(T elemento, Nodo nodo, int posicion) {
        if (nodo == null)
            return -1;
